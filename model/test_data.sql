...
INSERT INTO users(username, email, hashed_password, account_type, settings) VALUES
    ('mason k', 'mason@gmail.com', '$2a$08$1lCvpuZe5PyJ8HQIqivj8.S45c9POZqG3uLMp7OkoQTZbpwuehtfW', 'administrator', DEFAULT),
...
INSERT INTO spaces(creator_id, name, settings, permissions) VALUES
    (email_to_user('mason@gmail.com'), 'Space-1', '{"description": "Look at this great space!"}', DEFAULT),
...
INSERT INTO memberships(user_id, space_id, user_role) VALUES
    (email_to_user('mason@gmail.com'), 5, 1::role_t),
