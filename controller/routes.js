...
import directory_page_controller from './directory_page_controller.js';
...
function checkAuth(req, res, next) {
    ...
    if (req.session.user) next(); // TODO: FIX this is probably hackable
...
export default function routes(app, db) {
    ...
    app.get("/directory", checkAuth, getSidebarData, directory_page_controller(db));
